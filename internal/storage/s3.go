...
// ValidateEndpoint permits plain HTTP only outside production. Backup
// credentials and customer data must use a TLS-protected S3 endpoint in
// production, including S3-compatible services such as MinIO.
